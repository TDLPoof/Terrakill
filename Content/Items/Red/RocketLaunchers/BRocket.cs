...
public class BRocket : ModProjectile
{
    ...
    {
        if (Main.player[Projectile.owner].HeldItem.type == ModContent.ItemType<BarrageRocketLauncher>())
        {
            Main.player[Projectile.owner].HeldItem.GetGlobalItem<BarrageRocketManager>().barrageRockets++;
        }
