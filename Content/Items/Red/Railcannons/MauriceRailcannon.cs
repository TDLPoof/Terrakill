...
public class MauriceRailcannon : ModItem
{
    bool charging = false;
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<MauriceRailshot>();
        Item.shootSpeed = 1;
    ...
    public override void UpdateInventory(Player player)
    {
        ...
        Item.SetNameOverride("Railcannon (Malicious) - " + player.GetModPlayer<RailcannonCharge>().charge + "%");
    }
