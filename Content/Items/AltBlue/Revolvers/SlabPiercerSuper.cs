...
public class SlabPiercerSuper : ModProjectile
{
    ...
    {
        if (Main.rand.NextBool(3) && !Main.dedServ && Projectile.Distance(Main.player[Projectile.owner].position) < Main.screenWidth * 0.5f)
        {
    ...
    public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
    {
        ...
        ModContent.GetInstance<Hitstop>().hitstopping = 20;
    }
