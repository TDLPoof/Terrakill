...
namespace Terrakill.Content.Items.Blue.Revolvers;

public class PiercerRevolver : ModItem
{
    bool charging = false;
    float charge = 1.00f;
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<PiercerBullet>();
        Item.shootSpeed = 1;
    ...
    public override void UpdateInventory(Player player)
    {
        ...
        Item.SetNameOverride("Revolver (Piercer) - " + value);
        ...
        {
            if (charge < 0.00f && Keybinds.AltFire.Current) charge = 0.00f;

            if (charging && charge < 0.02f && !Keybinds.AltFire.Current)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    Projectile.NewProjectileDirect(player.GetSource_FromThis(), player.Center + muzzleOffset, velocity,
                                                   ModContent.ProjectileType<PiercerSuper>(), damage * 2, 0, player.whoAmI);
                }
                charge = 0.00f;
                charging = false;
            }
    ...
    public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
    {
        ...
        else
        {
            ...
            type = ModContent.ProjectileType<PiercerBullet>();
            charge -= 1f / 4f;
        }
    }
