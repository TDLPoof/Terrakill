...
public class EndMeRevolver : ModItem
{
    bool charging = false;
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<EndMeBullet>();
        Item.shootSpeed = 1;
    ...
    public override void UpdateInventory(Player player)
    {
        ...
        Item.SetNameOverride("Revolver (Marksman) - " + MathF.Round(coins, 2));
    ...
    public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
    {
        if (player.altFunctionUse == 2)
        {
            ...
            type = ModContent.ProjectileType<EndMeCoin>();
            velocity = new Vector2(MathF.Pow(32, 0.5f) * player.direction, -MathF.Pow(32, 0.5f));
