...
public class SlabSharpshooterBullet : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            Dust d;
            if (Main.rand.NextBool()) d = Dust.NewDustDirect(Projectile.Center, 1, 1, DustID.RedTorch);
    ...
    public void CoinBounce(Projectile originalCoin)
    {
        ...
        foreach (NPC npc in Main.npc)
        {
            ...
            if (npc.position.Distance(originalCoin.position) < 600)
            {
