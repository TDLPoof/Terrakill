...
public class ParryBomb : ModProjectile
{
    ...
    {
        if (!Main.dedServ && Projectile.Distance(Main.player[Projectile.owner].position) < Main.screenWidth * 0.75f && Main.rand.NextBool(3))
        {
            MakeADust(DustID.Torch);
        }
    }
